...
template <int K, int len_tile> __global__ void cuda_matrix_mul_patch_tiled_full_loaded (const float *A, const float *B, float *C, const int M, const int N, const int A_w, const int B_w);
